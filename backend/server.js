...
app.get('/health/deep', async (_req, res) => {
  ...
  res.json({
    ...
    kaliShell,
    personalDeveloper,
    documentAnalysis: isCloudMistralBrain() ? 'mistralbrain-cloud' : isSovereignBrain() ? 'ollama' : 'unconfigured',
    liveSearch: liveSearchAvailable() ? 'ready' : 'unavailable',
    voice: isCloudMistralBrain() ? 'browser-web-speech' : speechTranscriptionAvailable() ? 'ready' : 'needs_api_key',
    providers: getProviderStatus(),
