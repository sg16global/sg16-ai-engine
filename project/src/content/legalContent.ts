...
export const LEGAL_SECTIONS: { id: LegalSection; title: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Apache 2.0 applies to the Mistral model weights and usage terms published by the model licensor. SG16 application code and branding are © SaifTech Global Limited.',
